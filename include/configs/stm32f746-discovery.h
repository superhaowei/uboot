...
#define CONFIG_SYS_PROMPT		"STM32F769AI> "
...
#define CONFIG_STM32_HSE_HZ		16000000	/* 16 MHz */
#define CONFIG_STM32_PLL_M		(16)//(25)
...
#else
/*
 * USART1, TX PA.2, RX PA.3
 */
#define CONFIG_STM32_USART_PORT	        2	/* USART1 */
...
#define CONFIG_BOOTCOMMAND		"cp 8011000 60007fc0 7B000;bootm"
...
//initrd=0x60011000,0xE600 root=/dev/ram rw
//                                "init=/init root=/dev/ram rw " 
#endif
#define LOADADDR			"0x60007FC0"
